...
public class StateSensor extends Sensor 
{
	...
	private MessageListener m_chatListener;
	...
	public StateSensor(String serverAddress, String username, String password, MessageListener listener) throws XMPPException
	{
