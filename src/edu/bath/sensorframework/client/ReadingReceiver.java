 ...
 *
 */
public class ReadingReceiver implements ItemEventListener<Item> {
	private Map<String,List<String>> dataList;
	private Map<String, List<ReadingHandler>> handlersList;
	public ReadingReceiver(Map<String,List<String>> dataList, Map<String, List<ReadingHandler>> handlersList) {
...
//		System.out.println("Got item event.");
		...
		for(Item i : ilist) {
			...
			String rdf = data.getPayload().toXML();
